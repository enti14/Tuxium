function initialize()
{
  ...
  wait(2);
  Text.set_text(_("At the frozen shores of Antarctica, just before sunset..."));
  Text.fade_in(1);
  wait(4);
  Text.fade_out(1);
  wait(9.5);
  ...
  logo.fade_out(1.2);
  wait(2);
  Text.set_text(_("Tux was on his way to meet his friend Penny for a quiet picnic."));
  Text.fade_in(1);
  wait(4);
  Text.fade_out(1);
  wait(2.5);
...
Tux.do_duck();
  ...
  Tux.walk(0);
  wait(1.5); // t=4.4
  Text.set_text(_("Tux woke up dizzy and disoriented... Penny was gone!"));
  Text.fade_in(1);
  wait(2);
  Tux.do_jump(-150);
  wait(0.5);
  ...
  wait(2);
  Tux.walk(0);
  Text.set_text(_("Panic set in. Then Tux noticed a letter in the snow. It read:"));
  Text.fade_in(1);
  wait(5);
  Text.fade_out(1);
  wait(1);
  Text.set_text(_("\"Tux, I have taken Penny to my fortress.\""));
  Text.fade_in(1);
  wait(4);
  Text.fade_out(1);
  wait(1);
  Text.set_text(_("\"My minions now guard every path you might take.\""));
  Text.fade_in(1);
  wait(4);
  Text.fade_out(1);
  wait(1);
  Text.set_text(_("\"You will never reach her in time. — Nolok\""));
  Text.fade_in(1);
  wait(4);
  Text.fade_out(1);
  wait(1.5);
  Text.set_text(_("Tux clenched his flippers. No matter the danger, he would bring Penny home."));
  Text.fade_in(1);
  wait(2.5);
  Tux.do_jump(-350);
  wait(2.5);
  ...
  Tux.walk(250);
  wait(0.5);
  Text.set_text(_("Far beyond the snowfields, Nolok's fortress loomed on the horizon. The rescue had begun!")); // t=8.4
  Text.fade_in(1);
  wait(5);
  Text.fade_out(1);
  wait(3);
